...
\begin{figure}[h]
    ...
    \caption{Cumulative \ce{Zn} uptate by roots after 24 hours at $0.08$ \si{dm} distance apart.}
    \label{fig:OneCn}
\end{figure}
For this base model we choose parameters as in \cite{Ptashnyk-2011} and run the model with both roots the same. Our domain is symmetrical with one root on either side with equal parameters. This is evident as shown in figure \ref{fig:OneCn} which plots the cumulative \ce{Zn} uptake  in mols per decimeter over 24 hours. Above these plots are concentration plats which track the concentration of \ce{DMA} and \ce{Zn} in the soil respectively in mols per decimeter cubed. We show the final frames after 24 hours to give a snapshot of the results after a significant period of time. As we can see in this base model we observe a good amount of cooperation occurring between the two roots. The \ce{DMA} exuded from the left has run into that on the right which is causing more \ce{Zn} to be made available to both roots. As the domain is symmetric and the roots close enough that their rhizospheres meet this is as expected. Thus it is intuative to consider what happens when the roots are moved further apart and whether this band of increasd \ce{Zn} concentration is maintained ove 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
    ...
    \caption{Cumulative \ce{Zn} uptate by roots after 24 hours at $0.15$ \si{dm} distance apart, contrasted with the original model.}
\end{figure}
...
\subsubsection{Increased maximum \ce{DMA} exudation}
 ...
 \begin{figure}
     \centering
     \begin{subfigure}[t]{0.35\textwidth}
     \includegraphics[width=\textwidth]{Figures/testpics/IncreasedBufferDMA24.png} % Hi Liz~ Hi!
 ...
 \begin{figure}[h]
    ...
    \caption{Cumulative \ce{Zn} uptake by roots after 24 hours with an increased maximum \ce{DMA} exudation rate, contrasted with the original model.}
\end{figure}
...
\subsubsection{Increased distance between plants and maximum \ce{DMA} exudation}
 ...
 \begin{figure}[h]
    ...
    \caption{Cumulative \ce{Zn} uptate by roots after 24 hours at $0.15$ \si{dm} distance apart with an increased maximum \ce{DMA} exudation rate, contrasted with the original plot at this distance with no change in \ce{DMA}.}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \begin{figure}[h]
    ...
    \caption{Cumulative \ce{Zn} uptake by roots after 24 hours at $0.08$ \si{dm} distance apart with an increased maximum \ce{Zn} uptake rate, contrasted with the original model.}
\end{figure}
If instead we increase the rate of \ce{Zn} absorption by the rice plant we see that these plots remain very similar to our original model. Thus in the case of allowing a plant to better utilise the \ce{Zn} around it, this model suggests that when it comes to breeding rice plants it is better to focus on increasing the expression of genes geared towards \ce{DMA} exudation than to increase transporter strength which would mirror the simulated increase in maximum \ce{Zn} uptake here. Increased \ce{DMA} exudation has a much larger impact upon \ce{Zn} uptake with an increase of just $1e^{-11}$mols per decimetres squared per second rather than the larger increase of $5e^{-3}$mols plotted here giving an observably larger increase in \ce{Zn} transported. \textcolor{red}{Input exact numbers from simulation}
