...
\subsubsection{Increased distance between roots}
 \begin{figure}
     ...
     \includegraphics[width=\textwidth,trim=100 100 110 150,clip]{Figures/testpics/0.15ApartDMA24.png}
     \caption{0.15 dm apart \ce{DMA} after 24 hours}
     \end{subfigure}
     \begin{subfigure}[t]{0.45\textwidth}
     \includegraphics[width=\textwidth,trim=100 100 125 150,clip]{Figures/testpics/0.15ApartZn24.png}
...
\subsubsection{Increased maximum \ce{DMA} exudation}
 ...
 \begin{figure}
     ...
     \begin{subfigure}[t]{0.45\textwidth}
     \includegraphics[width=\textwidth,trim=100 100 110 150,clip]{Figures/testpics/IncreasedBufferDMA24.png}
     \caption{0.08 apart, rate of \ce{DMA} exudation increased by $10^{-11}$, \ce{DMA} after 24 hours}
     \end{subfigure}
     \begin{subfigure}[t]{0.45\textwidth}
     \includegraphics[width=\textwidth,trim=100 100 125 150,clip]{Figures/testpics/IncreasedBufferZn24.png}
...
\subsubsection{Increased distance between plants and maximum \ce{DMA} exudation}
 ...
 \begin{figure}
     ...
     \begin{subfigure}[t]{0.45\textwidth}
     \includegraphics[width=\textwidth,trim=100 100 125 150,clip]{Figures/testpics/IncreasedBufferAndDistancedDMA24.png}
     \caption{0.15 apart, rate of \ce{DMA} exudation increased by $10^{-11}$, \ce{DMA} after 24 hours}
    \end{subfigure}
     \begin{subfigure}[t]{0.45\textwidth}
     \includegraphics[width=\textwidth,trim=100 100 125 150,clip]{Figures/testpics/IncreasedBufferAndDistanceZn24.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \begin{figure}
     ...
     \caption{Distance and \ce{DMA} exudation increased}
     \begin{subfigure}[t]{0.45\textwidth}
     \includegraphics[width=\textwidth,trim=100 100 125 150,clip]{Figures/testpics/IncreasedZnAbsorbDMA24.png}
     \caption{0.08 apart, rate of \ce{Zn} absorption increased by $0.5e^{-2}$, \ce{DMA} after 24 hours}
     \end{subfigure}
     \centering
     \begin{subfigure}[t]{0.45\textwidth}
     \includegraphics[width=\textwidth,trim=100 100 125 150,clip]{Figures/testpics/IncreasedZnAbsorbZn24.png}
